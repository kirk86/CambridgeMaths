...
\begin{proof}
  ...
  \begin{IEEEeqnarray*}{rlr}
    ...
    & (X-\alpha_2)(X-\alpha_é^p)\cdots(X-\alpha_2^{p^{n_2-1}}) & \leftarrow Q_2 \\
    & \cdots{}(X-\alpha_m)\cdots{}(X-\alpha_m^{p^{n_m-1}}) & \leftarrow Q_m
  \end{IEEEeqnarray*}
and $\operatornam{Fr}_p$ acts on these n roots by a permutation of cycle type $(n_1, \ldots, n_m)$.
\end{proof}
