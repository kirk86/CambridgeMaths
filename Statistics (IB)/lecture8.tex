then, we have that the likelihood ratio is
...
The p-value\index{p-value} (or significance value\index{significance value}) of an observed value $Z = z$ in the previous example is
\[
