...
A holomorphic function $\varphi : \tilde{U} \rightarrow \CC$ such that $\varphi\rvert_U \equiv h$ is called an analytic continuation\index{analytic continuation} of $h$ to $\tilde{U}$.
\end{definition}
